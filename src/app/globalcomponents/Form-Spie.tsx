    ...
    >
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full px-4 py-2 rounded border border-red-600 bg-black text-white text-sm placeholder:text-xs focus:outline-none focus:ring-2 focus:ring-red-700 placeholder:opacity-70"
        />
      </div>

      <div className="mb-4">
        <label htmlFor="secondName" className="block text-sm mb-2 text-red-600">
          Apellidos
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="email" className="block text-sm mb-2 text-red-600">
