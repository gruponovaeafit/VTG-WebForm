...
export default function InfoUn() {
    ...
    return (
        <div className="bg-gray-800 bg-opacity-90 p-4 rounded-lg shadow-lg max-w-md w-full">
            ...
            <h1 className="mb-1 text-blue-400">ASSESSMENT 2025-1</h1>
        ...
        <button
            ...
            className="w-full mt-2 py-3 px-2 bg-yellow-400 text-black rounded shadow hover:bg-yellow-500 active:bg-yellow-600 font-bold uppercase tracking-wider transition duration-300"
        >
            Siguiente
        </button>
