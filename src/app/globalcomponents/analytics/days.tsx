    ...
    <div className="p-6 rounded-lg shadow-lg" style={{ backgroundColor: "#000000", color: "#FFFFFF" }}>
      <div className="flex items-center space-x-3">
        <div className="p-2 rounded-lg" style={{ backgroundColor: "rgba(255, 0, 255, 0.1)", border: "1px solid #FF00FF" }}>
          <Calendar className="h-4 w-4" style={{ color: "#FF00FF" }} />
        </div>
        <div>
      ...
      <div className="flex items-center space-x-2 mb-2">
        <div className="flex space-x-1">
          ...
          <div className="w-2 h-2 rounded-full animate-pulse delay-75" style={{ backgroundColor: "#00FFFF" }}></div>
          <div className="w-2 h-2 rounded-full animate-pulse delay-150" style={{ backgroundColor: "#00FFFF" }}></div>
        </div>
