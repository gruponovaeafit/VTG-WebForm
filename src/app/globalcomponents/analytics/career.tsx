...
export default function UsersByDegreeChart() {
  ...
  return (
    <div className="p-6 rounded-lg shadow-lg" style={{ backgroundColor: COLORS.background, color: COLORS.text }}>
      <h2 className="text-2xl font-bold mb-4" style={{ color: COLORS.title }}>Usuarios por Carrera</h2>
      <ResponsiveContainer width="100%" height={400}>
        <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid stroke={COLORS.grid} strokeDasharray="3 3" />
          <XAxis dataKey="pregrado" stroke={COLORS.axis} tick={{ fill: COLORS.axis, fontSize: 14 }} />
