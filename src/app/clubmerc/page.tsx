...
import ClubmercForm from "../globalcomponents/Form-Clubmerc";
...
export default function Home() {
  ...
  return (
    ...
    style={{
      backgroundImage: "url('/clubmerc.jpg')",
    ...
    >
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start relative z-10 ">
        <h1 className="text-4xl md:text-2xl text-center mb-6 pixel-font text-white glitch_clubmerc">
          CLUBMERC
        </h1>
