...
const GLOBAL_PASSWORD = process.env.NEXT_PUBLIC_SPIE_TSS; // Definir la contraseña global aquí
...
export default function SpiePage() {
  ...
  return (
    <div className="p-2 h-screen overflow-auto bg-black text-green-300 font-mono">
      <h1 className="text-lg font-bold mb-2 text-yellow-300 border-b border-yellow-500">SPIE - Charlas</h1>
