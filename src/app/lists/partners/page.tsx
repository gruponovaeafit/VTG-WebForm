...
const GLOBAL_PASSWORD = process.env.NEXT_PUBLIC_PARTNERS_TSS; // Definir la contraseña global aquí
...
export default function PartnersPage() {
  ...
  return (
    <div className="p-2 h-screen overflow-auto bg-black text-green-300 font-mono">
      <h1 className="text-lg font-bold mb-2 text-yellow-300 border-b border-yellow-500">Partners - Charlas</h1>
