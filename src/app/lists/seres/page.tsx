...
const GLOBAL_PASSWORD = process.env.NEXT_PUBLIC_SERES_TSS; // Definir la contraseña global aquí
...
export default function SeresPage() {
  ...
  return (
    <div className="p-2 h-screen overflow-auto bg-black text-green-300 font-mono">
      <h1 className="text-lg font-bold mb-2 text-yellow-300 border-b border-yellow-500">Seres - Charlas</h1>
